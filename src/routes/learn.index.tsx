...
import { Check, ChevronRight, Clock, Play, Loader2 } from "lucide-react";
...
import { runCode } from "@/api/submissions";
        ...
        <div className="rounded-2xl border border-card bg-surface">
          ...
          <div className="flex items-center justify-between border-t border-card px-4 py-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg gradient-bg px-4 py-2 text-sm font-semibold text-background disabled:opacity-70"
            >
